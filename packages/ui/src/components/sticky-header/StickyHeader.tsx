...
export function StickyHeader({ variant = "default", loading = false, empty = false, children, header, footer, onClick }: StickyHeaderProps) {
  const rows = [
  ...
  return (
    <div className={styles.wrapper} data-testid="sticky-header" role="region" aria-label="StickyHeader">
