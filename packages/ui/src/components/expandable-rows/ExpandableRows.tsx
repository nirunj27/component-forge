...
export function ExpandableRows({ variant = "default", loading = false, empty = false, children, header, footer, onClick }: ExpandableRowsProps) {
  const rows = [
  ...
  return (
    <div className={styles.wrapper} data-testid="expandable-rows" role="region" aria-label="ExpandableRows">
...
ExpandableRows.displayName = "ExpandableRows";
