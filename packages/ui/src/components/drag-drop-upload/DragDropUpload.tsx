 ...
 */
export function DragDropUpload({ label, value = "", placeholder = "", disabled = false, required = false, error, onChange, onBlur }: DragDropUploadProps) {

  const inputId = React.useId();
  const errorId = `${inputId}-error`;
  return (
    <div className={styles.wrapper} data-testid="drag-drop-upload">
