...
export function SortableTable({ variant = "default", loading = false, empty = false, children, header, footer, onClick }: SortableTableProps) {
  const rows = [
  ...
  return (
    <div className={styles.wrapper} data-testid="sortable-table" role="region" aria-label="SortableTable">
